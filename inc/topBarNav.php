        ...
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
              ...
              <a href="./farming/log.php" class="mx-2 text-light text-decoration-none font-weight-bolder"> farmers' Application</a> |
              <a href="./admin" class="mx-2 text-light text-decoration-none font-weight-bolder"></a>
            <?php endif; ?>
          </div>
        </div>
      </nav>

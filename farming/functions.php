...
$conn=mysqli_connect("localhost:3307","root","", "mvogms_db");

if(isset($_POST['save_profile'])){
    $username=stripslashes($_POST['username']);
    $email=stripslashes($_POST['email']);
    $association=stripslashes($_POST['association']);
    ...
    if(move_uploaded_file($_FILES['image']['tmp_name'], $target_file)){
        ...
        $sql="INSERT INTO user SET image='$image', username='$username',email='$email',association='$association',code='$code'";
